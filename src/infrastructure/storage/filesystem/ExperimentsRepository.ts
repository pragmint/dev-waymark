...
import type { ExperimentsRepository } from '../../../application/experiments/Repository';

export class FilesystemExperimentsRepository implements ExperimentsRepository {
